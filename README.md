...
<!-- dsh:panorama:start -->
截至 2026-09-16 共收录 **12866** 个经核实的仓库。它们长这样：
...
截至 2026-09-16，全量目录收录 **12866** 个仓库、**33** 种主要语言；其中 **11475** 个声明了许可证，**12785** 个未归档且未禁用（目录随人工审核合并更新，最新统计以 [CATALOG.md](./CATALOG.md) 为准）。
